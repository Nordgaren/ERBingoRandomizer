...
#define FMT_NOMACRO
    ...
    namespace detail {
        ...
        template <typename CodeUnit>
        constexpr size_t codecvt_result<CodeUnit>::max_size;
...
#  pragma clang diagnostic pop
        ...
        OutputIt write_encoded_tm_str(OutputIt out, string_view in, const std::locale& loc) {
            if (is_utf8() && loc != get_classic_locale()) {
    ...
    using code_unit = wchar_t;
        ...
        void do_write(buffer<Char>& buf, const std::tm& time,
...
inline void tzset_once() {
  ...
  ignore_unused(init);
        ...
        private:
            ...
            int tm_sec() const noexcept {
                FMT_ASSERT(tm_.tm_sec >= 0 && tm_.tm_sec <= 61, "");
                return tm_.tm_sec;
            }

            int tm_min() const noexcept {
                FMT_ASSERT(tm_.tm_min >= 0 && tm_.tm_min <= 59, "");
                return tm_.tm_min;
            }

            int tm_hour() const noexcept {
                FMT_ASSERT(tm_.tm_hour >= 0 && tm_.tm_hour <= 23, "");
                return tm_.tm_hour;
            }

            int tm_mday() const noexcept {
                FMT_ASSERT(tm_.tm_mday >= 1 && tm_.tm_mday <= 31, "");
                return tm_.tm_mday;
            }

            int tm_mon() const noexcept {
                FMT_ASSERT(tm_.tm_mon >= 0 && tm_.tm_mon <= 11, "");
                return tm_.tm_mon;
            }

            long long tm_year() const noexcept { return 1900ll + tm_.tm_year; }

            int tm_wday() const noexcept {
                FMT_ASSERT(tm_.tm_wday >= 0 && tm_.tm_wday <= 6, "");
                return tm_.tm_wday;
            }

            int tm_yday() const noexcept {
                FMT_ASSERT(tm_.tm_yday >= 0 && tm_.tm_yday <= 365, "");
                return tm_.tm_yday;
            }

            int tm_hour12() const noexcept {
            ...
            int split_year_lower(long long year) const noexcept {
                auto l = year % 100;
            ...
            int iso_year_weeks(long long curr_year) const noexcept {
            ...
            int iso_week_num(int tm_yday, int tm_wday) const noexcept {
                return (tm_yday + 11 - (tm_wday == 0 ? days_per_week : tm_wday)) /
                    days_per_week;
            }

            long long tm_iso_week_year() const noexcept {
            ...
            int tm_iso_week_of_year() const noexcept {
                const auto year = tm_year();
                const auto w = iso_week_num(tm_yday(), tm_wday());
    ...
    write_utc_offset(-offset);
        ...
        public:
            ...
            void on_iso_date() {
                ...
                write_digit2_separated(buf + 2, year % 100,
        ...
        std::chrono::duration<Rep, std::milli> get_milliseconds(
  ...
  return std::chrono::duration_cast<std::chrono::milliseconds>(d - s);
        ...
        public:
            get_locale(bool localized, locale_ref loc) : has_locale_(localized) {
                if (localized)
                    ::new(&locale_) std::locale(loc.get<std::locale>());
            }
...
using weekday = std::chrono::weekday;
    ...
    protected:
        ...
        FMT_CONSTEXPR It do_parse(It begin, It end, bool with_default = false) {
