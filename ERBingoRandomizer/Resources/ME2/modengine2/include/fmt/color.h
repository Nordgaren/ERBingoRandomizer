...
FMT_BEGIN_NAMESPACE
    ...
    FMT_BEGIN_DETAIL_NAMESPACE
        ...
        FMT_CONSTEXPR ansi_color_escape<Char> make_foreground_color(
            color_type foreground) FMT_NOEXCEPT {
            return ansi_color_escape<Char>(foreground, "\x1b[38;2;");
        }

        template <typename Char>
        FMT_CONSTEXPR ansi_color_escape<Char> make_background_color(
            color_type background) FMT_NOEXCEPT {
    ...
    */
    ...
    std::basic_string<Char> format(const text_style& ts, const S& format_str,
                                   const Args&... args) {
    ...
    */
    ...
    inline typename std::enable_if<enable, OutputIt>::type format_to(OutputIt out, const text_style& ts,
                                                                     const S& format_str,
                                                                     Args&&... args) {
