...
#  define FMT_SNPRINTF fmt_snprintf
        ...
        FMT_FUNC void format_error_code(buffer<char>& out, int error_code,
        ...
        FMT_FUNC thousands_sep_result<Char> thousands_sep_impl(locale_ref loc) {
...
template <typename Char> FMT_FUNC Char decimal_point_impl(locale_ref) {
  return '.';
    ...
    namespace detail {
        template <>
        FMT_FUNC int count_digits<4>(fallback_uintptr n) {
...
#  pragma GCC diagnostic pop
        ...
        template <typename T>
        struct bits {
            static FMT_CONSTEXPR_DECL int value =
        ...
        struct fp {
            ...
            static constexpr int num_significand_bits = bits<decltype(f)>::value;
            ...
            template <typename Float>
            explicit FMT_CONSTEXPR fp(Float n) { assign(n); }
  ...
  return (static_cast<uint64_t>(product) & (1ULL << 63)) != 0 ? f + 1 : f;
        ...
        FMT_CONSTEXPR fp get_cached_power(int min_exponent,
            ...
            return {
                impl_data::pow10_significands[index],
        ...
        private:
            ...
            static FMT_CONSTEXPR_DECL int bigit_bits = bits<bigit>::value;
...
#  endif
  ...
  return FMT_BUILTIN_CTZLL(x) >= exp;
            ...
            inline bool divisible_by_power_of_5(uint32_t x, int exp) FMT_NOEXCEPT {
                ...
                static constexpr divtest_table_entry<uint32_t> divtest_table[] = {
            ...
            inline bool divisible_by_power_of_5(uint64_t x, int exp) FMT_NOEXCEPT {
                ...
                static constexpr divtest_table_entry<uint64_t> divtest_table[] = {
            ...
            struct cache_accessor<double> {
                ...
                static uint128_wrapper get_cached_power(int k) FMT_NOEXCEPT {
                    ...
                    static constexpr uint128_wrapper pow10_significands[] = {
    ...
    return pow10_significands[k - float_info<double>::min_k];
                    ...
                    static constexpr uint32_t pow10_recovery_errors[] = {
  ...
  int t = FMT_BUILTIN_CTZLL(n);
            ...
            template <class T>
            decimal_fp<T> shorter_interval_case(int exponent) FMT_NOEXCEPT {
