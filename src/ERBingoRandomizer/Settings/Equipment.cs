...
{   // TODO make into an initialization method for repeat randomizer calls
    ...
    { // includes backhand blades
        ...
        7050000, 2080000, 7060000, 7070000, 7080000, 7120000,
        7140000, 7150000, 7500000, 7510000, 7520000, 7530000,
        64500000, 64510000, 64520000,
    };
    public static List<int> DaggerIDs = new List<int>()
    { // includes throwing blades
        1000000, 1010000, 1020000, 1030000, 1040000, 1050000, 1060000, 1070000, 1080000,
        1090000, 1100000, 1110000, 1130000, 1140000, 1150000, 1160000, 1500000, 1510000,
        63500000,
    };
    ...
    {
        ClawIDs, DaggerIDs, FistIDs, HeavyThrustingIDs,
    ...
    {   // TODO non-exhaustive list of weapons. Until level calc is working again a smaller list of weapons that are more likely to be equippable
        // DLC
        19500000, 6500000, 9500000, 2510000, 2520000, 2540000, 2550000, 2560000, 4520000,
        14540000, 14500000, 14520000, 14510000, 64500000, 64510000, 64520000, // daggers, axes, backhand blades 
        ...
        4540000, 4500000, 62500000, 62510000, 16540000, 16520000, 10510000, 22500000, 68500000, 68510000, 
