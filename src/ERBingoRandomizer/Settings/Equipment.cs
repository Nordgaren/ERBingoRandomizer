...
{   // TODO make into an initialization method for repeat randomizer calls
    ...
    public static List<int> LightBowIDs = new List<int>
    {
        40000000, 40010000, 40020000, 40030000, 40050000, 40500000,
    };
    public static List<int> BowIDs = new List<int>
    {
        41510000, 41000000, 41010000, 41020000, 41030000, 41040000, 41060000, 41070000,
    };
    public static List<int> GreatBowIDs = new List<int>
    {
        42010000, 42030000, 42040000, 42500000,
    };
    ...
    public static List<int> BallistaIDs = new List<int>
    {
        44500000, 44000000, 44010000,
    };
    ...
    {   // TODO non-exhaustive list of weapons. Until level calc is working again a smaller list of weapons that are more likely to be equippable
        ...
        64500000, 64510000, 64520000,    // backhand blades
        22500000, 60500000, 60510000, 68500000, 68510000,    // claws / hand arts / beast claws
        21500000, 21510000, 21520000, 21530000, 21540000, // fist
        7530000, 7520000, 7510000, 7500000, 66500000, 66510000, 66520000, // curved / great katana
        12500000, 16550000, 17510000, 67500000, 67510000,   // greathammer / greatspears / light greatswords
        3520000, 3550000, 18500000, 8520000, 8510000,     // greatsword / halberd / CGS
        19500000, 6500000, 9500000, 2510000, 2520000, 2530000, 2540000, 2550000, 2560000, // one offs
        4520000, 4540000, 4500000, 20500000, 62500000, 62510000, 16540000, 16520000, 10510000,
        // Base Game
        1000000, 1010000, 1020000, 1030000, 1040000, 1050000, 1060000, 1070000, 1080000, 1090000,
        1100000, 1130000, 1140000, 1150000, 1160000, 14000000, 14010000, 14020000, 14030000,
        14040000, 14060000, 14080000, 14100000, 14110000, 22000000, 22010000, 22020000, 22030000,
        8020000, 8060000, 8030000, 8010000, 8050000, 4040000, 4000000, 7000000, 7010000, 7030000,
        7040000, 7050000, 7080000, 7110000, 7120000, 7140000, 7150000, 21000000, 21010000, 21070000,
        21080000, 21100000, 21120000, 15050000, 15020000, 15060000, 6000000, 6020000, 3070000,
        12000000, 12020000, 12140000, 12130000, 12180000, 12010000, 17060000, 18110000, 18140000,
        3000000, 3180000, 3020000, 3030000, 3040000, 3050000, 3010000, 3190000, 3160000, 3200000,
        18000000, 18010000, 18020000, 18030000, 18040000, 18070000, 18080000, 2150000, 2190000,
        19000000, 19010000, 19020000, 19060000, 9000000, 9030000, 9070000, 2060000, 2070000,
        2000000, 2010000, 2020000, 2040000, 2050000, 2200000, 2210000, 2230000, 2250000, 2260000,
        ...
        5050000, 5000000, 5010000, 5020000, 5040000, 24020000, 24060000, 10000000, 10010000, 10030000,
        10080000, 20000000, 20020000, 20050000, 20070000, 30000000, 30010000, 30020000, 30030000, 30040000,
        30070000, 30080000, 30090000, 30100000, 30110000, 30120000, 30130000, 30140000, 30150000, 30190000,
        30200000, 31040000, 31050000, 31070000, 31080000, 31100000, 31140000, 31170000, 31230000, 31250000,
        31260000, 31270000, 31280000, 31290000, 31300000, 31320000, 31330000, 32000000, 32020000, 32030000,
