...
public class Season2ClassRandomizer : IBingoClassStrategy {
    ...
    private bool hasWeaponOfType(Params.CharaInitParam chr, params ushort[] types) {
    ...
    private void giveRandomWeapon(Params.CharaInitParam chr, ushort type) {
    ...
    private int getRandomWeapon(Params.CharaInitParam chr, ushort type) {
